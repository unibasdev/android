...
public class ActivityFormEsame extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager()
                .beginTransaction()
                .add(R.id.containerVistaFormEsame, new VistaFormEsame())
                .commit();
    }

    public VistaFormEsame getVistaFormEsame() {
        return (VistaFormEsame) this.getSupportFragmentManager().findFragmentById(R.id.containerVistaFormEsame);
    }
    ////////////////////////// MENU ////////////////////////////
